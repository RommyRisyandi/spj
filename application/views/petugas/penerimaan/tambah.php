...
// Form Open
echo form_open(base_url('petugas/penerimaan/tambah'), 'class="form-horizontal"');
?>
                    ...
                    <div class="card">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="date" name="tanggal_post" class="datetimepicker form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <h2 class="card-inside-title">Uraian Belanja</h2>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea name="uraian_belanja" class="form-control no-resize" placeholder="Masukkan Uraian Belanja..." id="editor"><?php echo set_value('uraian_belanja'); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
