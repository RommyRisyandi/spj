...
// Form Open
echo form_open(base_url('admin/koreksi/tambah/'.$koreksi->id_penerimaan), 'class="form-horizontal"');
?>
                            ...
                            <h2 class="card-inside-title">Jenis Koreksi</h2>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea name="jenis_koreksi" class="form-control no-resize" placeholder="Masukkan Jenis Koreksi..." id="editor"><?php echo set_value('jenis_koreksi'); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
