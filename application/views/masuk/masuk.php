...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
            <a href="<?php echo base_url('login'); ?>"><img src="<?php echo base_url(); ?>/assets2/images/logo_spj.png" width="200" height="200"></b></a>
        </div>
        <div class="card">
            <div class="body">
...
<?php 
 ...
 ?>
                    ...
                    <div class="row m-t-15 m-b--20">
                        <div class="col-xs-6">
                            <a href="<?php echo base_url('login'); ?>">Masuk Sebagai Admin Utama</a>
                        </div>
                    </div>
                </form>
            </div>
